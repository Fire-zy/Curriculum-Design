    ...
    public partial class FrmSearchList : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string sql = "insert into PrisonAdd(pri_name,pri_age,pri_sex,pri_ondata,pri_address,pri_id,pri_reason) values('" + name + "','" + age + "','" + sex + "','" + ondata + "','" + address + "','" + id + "','" + reason + "')";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string sql = "update PrisonAdd set pri_name='" + name + "',pri_age='" + age + "',pri_sex='" + sex + "',pri_ondata='" + ondata + "',pri_address='" + address + "',pri_id='" + id + "',pri_reason='" + reason + "'";
            SqlCommand command = new SqlCommand(sql, sqlCnt);
